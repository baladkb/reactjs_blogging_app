            ...
            <div className="col-md-5">
                <div className="form-area">
                    <form role="form">
                        ...
                        <div className="form-group">
                            <textarea className="form-control" type="textarea" onChange={this.handleSubjectChange} name="subject"id="subject" placeholder="Subject" maxlength="140" rows="7"></textarea>
                        </div>
